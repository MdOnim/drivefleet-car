...
export default function WhyChooseSection() {
  return (
    <section className="bg-[#0d1520] text-zinc-100 py-10 px-6 md:px-20 font-sans antialiased">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto items-stretch">
        <div className="group bg-[#0b1119] border border-gray-800 rounded-2xl p-6 hover:border-cyan-500/50 hover:shadow-[0_0_30px_rgba(34,211,238,0.1)] transition-all duration-300 flex flex-col h-full">
          <Car
            className="text-cyan-400 group-hover:scale-110 transition-transform duration-300 mb-4 flex-shrink-0"
            size={28}
          />
          <h3 className="text-lg font-bold text-zinc-200 uppercase tracking-wide mb-2">
            Wide Range of Cars
          </h3>
          <p className="text-sm text-zinc-400 leading-relaxed font-normal flex-grow">
