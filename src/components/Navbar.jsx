...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    ...
    // const protectedRoutes = ["/add-car", "/my-bookings", "/my-added-car"];
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                <Link
                  href="/login"
                  className="px-3 py-2 text-sm text-gray-400 hover:text-cyan-400"
                >
                  Login
                </Link>
                <Link
                  href="/register"
                  className="px-4 py-2 text-sm font-medium text-slate-950 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-xl shadow-[0_0_15px_rgba(34,211,238,0.4)]"
                >
                  Register
                </Link>
              </div>
              ...
              return (
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-medium rounded-xl transition-all ${
                    isActive
                      ? "bg-cyan-950/50 text-cyan-400 border-l-4 border-cyan-400"
            ...
            {user ? (
              ...
              <div className="flex flex-col gap-2 pt-2 border-t border-gray-800">
                <Link
                  href="/login"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="w-full text-center py-2 text-sm text-gray-400 bg-gray-900 rounded-xl"
                >
                  Login
                </Link>
                <Link
                  href="/register"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="w-full text-center py-2 text-sm font-medium text-slate-950 bg-gradient-to-r from-cyan-400 to-teal-400 rounded-xl"
                >
                  Register
                </Link>
              </div>
